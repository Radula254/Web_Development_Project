...
if(isset($_POST['add'])) {
    ...
    if(empty($first_name) || empty($last_name)){
        $error[]="First name and last name are requested.";
    ...
    if(empty($errors)) {
        //Prepare and execute insertion sql statement.
        $sql = "INSERT INTO managers(fname, lname, DOE, department, email, pnumber, password) VALUES($first_name, $last_name, $date_of_employment, $department, $email, $pnumber, $password)";
...
<body>
    ...
    <div class="container">
        <div class="form-section">
            ...
            <label for="date_of_employment">Date:</label><br>
            <input type="date" name="date_of_employment" id="date_of_employment" required><br>
