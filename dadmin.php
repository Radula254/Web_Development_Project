...
if (isset($_POST['add'])) {
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO doctors (fname, lname, DOE, department, speciality, email, pnumber, salary, password)
                VALUES ('$first_name', '$last_name', '$date_of_employment', '$department', '$speciality', '$email', '$pnumber', '$salary, '$password')";
