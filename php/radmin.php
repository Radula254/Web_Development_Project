...
if (isset($_POST['delete'])) {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        $update_query = "UPDATE receptionsts SET id = id - 1 WHERE id > $receptionist_id";
        if ($conn->query($update_query) === TRUE) {
            echo "Receptionist deleted successfully and IDs renumbered.";
        } else {
